...
For the ppc64le architecture, we used the python libraries from a private gemfury:
pip install -U --extra-index-url https://repo.fury.io/mgiessing --prefer-binary chromadb
pip install -U --extra-index-url https://repo.fury.io/mgiessing --prefer-binary llama-cpp-python
